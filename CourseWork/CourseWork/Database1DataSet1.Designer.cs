...
namespace CourseWork {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ContractDataTable : global::System.Data.TypedTableBase<ContractRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ContractRow AddContractRow(ClientRow parentClientRowByFK_Contract_ToTable, int IdDealer, System.DateTime DateOfConclusion, string Brand, bool PhotoOfAuto, System.DateTime ReleaseDate, int Mileage, System.DateTime SaleDate, int Price, int CommissionAmount, string Note) {
            ...
            public string Note {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Note\' в таблице \'Contract\' равно DBNull.", e);
                    }
                }
                set {
...
SELECT IdClient, FirstName, SecondName, Patronymic, City, ResidentialAddress, PhoneNumber FROM Client WHERE (IdClient = @IdClient)";
    ...
    public partial class ContractTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Contract] ([IdClient], [IdDealer], [DateOfConclusion], [Brand], [PhotoOfAuto], [ReleaseDate], [Mileage], [SaleDate], [Price], [CommissionAmount], [Note]) VALUES (@IdClient, @IdDealer, @DateOfConclusion, @Brand, @PhotoOfAuto, @ReleaseDate, @Mileage, @SaleDate, @Price, @CommissionAmount, @Note);
SELECT IdContract, IdClient, IdDealer, DateOfConclusion, Brand, PhotoOfAuto, ReleaseDate, Mileage, SaleDate, Price, CommissionAmount, Note FROM Contract WHERE (IdContract = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contract] SET [IdClient] = @IdClient, [IdDealer] = @IdDealer, [DateOfConclusion] = @DateOfConclusion, [Brand] = @Brand, [PhotoOfAuto] = @PhotoOfAuto, [ReleaseDate] = @ReleaseDate, [Mileage] = @Mileage, [SaleDate] = @SaleDate, [Price] = @Price, [CommissionAmount] = @CommissionAmount, [Note] = @Note WHERE (([IdContract] = @Original_IdContract) AND ([IdClient] = @Original_IdClient) AND ([IdDealer] = @Original_IdDealer) AND ((@IsNull_DateOfConclusion = 1 AND [DateOfConclusion] IS NULL) OR ([DateOfConclusion] = @Original_DateOfConclusion)) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_PhotoOfAuto = 1 AND [PhotoOfAuto] IS NULL) OR ([PhotoOfAuto] = @Original_PhotoOfAuto)) AND ((@IsNull_ReleaseDate = 1 AND [ReleaseDate] IS NULL) OR ([ReleaseDate] = @Original_ReleaseDate)) AND ((@IsNull_Mileage = 1 AND [Mileage] IS NULL) OR ([Mileage] = @Original_Mileage)) AND ((@IsNull_SaleDate = 1 AND [SaleDate] IS NULL) OR ([SaleDate] = @Original_SaleDate)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_CommissionAmount = 1 AND [CommissionAmount] IS NULL) OR ([CommissionAmount] = @Original_CommissionAmount)) AND ((@IsNull_Note = 1 AND [Note] IS NULL) OR ([Note] = @Original_Note)));
SELECT IdContract, IdClient, IdDealer, DateOfConclusion, Brand, PhotoOfAuto, ReleaseDate, Mileage, SaleDate, Price, CommissionAmount, Note FROM Contract WHERE (IdContract = @IdContract)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdContract, IdClient, IdDealer, DateOfConclusion, Brand, PhotoOfAuto, Rele" +
                "aseDate, Mileage, SaleDate, Price, CommissionAmount, Note FROM dbo.Contract";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_IdContract));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_IdClient));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_IdDealer));
            if ((Original_DateOfConclusion.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[15].Value = ((System.DateTime)(Original_DateOfConclusion.Value));
            }
            else {
            ...
            if ((Original_PhotoOfAuto.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((bool)(Original_PhotoOfAuto.Value));
            }
            else {
            ...
            if ((Original_Mileage.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((int)(Original_Mileage.Value));
            }
            else {
            ...
            if ((Original_CommissionAmount.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((int)(Original_CommissionAmount.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[32].Value = ((int)(IdContract));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_CommissionAmount, 
                    string Original_Note) {
            return this.Update(IdClient, IdDealer, DateOfConclusion, Brand, PhotoOfAuto, ReleaseDate, Mileage, SaleDate, Price, CommissionAmount, Note, Original_IdContract, Original_IdClient, Original_IdDealer, Original_DateOfConclusion, Original_Brand, Original_PhotoOfAuto, Original_ReleaseDate, Original_Mileage, Original_SaleDate, Original_Price, Original_CommissionAmount, Original_Note, Original_IdContract);
        }
    }
...
SELECT IdDealer, FirstName, SecondName, Patronymic, Photo, ResidentialAddress, PhoneNumber FROM Dealer WHERE (IdDealer = @IdDealer)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Database1DataSet1.DealerDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Database1DataSet1.DealerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.DealerDataTable dataTable = new Database1DataSet1.DealerDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.DealerDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
